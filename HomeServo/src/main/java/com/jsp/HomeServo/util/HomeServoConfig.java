...
public class HomeServoConfig {
	...
	public Docket getDocket() {
		Contact contact=new Contact("jspider", "www.jspider.com", "jspider@gmail.com");
		List<VendorExtension> extensions=new ArrayList<>();
		
		ApiInfo apiInfo=new ApiInfo("HomeServo", "Job provider for home services", "venrsion 1.0", "terms of condition", contact, "license", "url", extensions);
